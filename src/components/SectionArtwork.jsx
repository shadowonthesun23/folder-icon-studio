  ...
  return (
    <section className="rounded-xl border border-white/[0.07] bg-[#09090b] overflow-hidden">
      ...
      <div className="p-4 space-y-4">
          ...
          <label
            ...
            style={coverSrc && !isDraggingOver
              ...
              : isDraggingOver
                ...
                : { backgroundColor: '#121214', borderColor: 'rgba(255,255,255,0.1)' }}
          >
            ...
            <div className="relative z-10 flex flex-col items-center space-y-2 text-center">
              <div className={`p-3 rounded-full transition-colors ${
                isDraggingOver ? 'bg-blue-500/20' : coverSrc ? 'bg-white/10 group-hover:bg-white/20' : 'bg-neutral-800 group-hover:bg-blue-500/20'
              }`}>
        ...
        {/* Zoom + Rotation */}
        {coverSrc && (
          <div className="bg-[#121214] p-3 rounded-xl border border-white/5 space-y-3">
            <div>
              <div className="flex justify-between items-center text-xs text-neutral-400 mb-2">
                <span className="flex items-center gap-1"><ZoomIn size={13} /> {t.zoom}</span>
            ...
            <div>
              <div className="flex justify-between items-center text-xs text-neutral-400 mb-2">
                <span className="flex items-center gap-1"><RotateCw size={13} /> {t.coverRotation}</span>
